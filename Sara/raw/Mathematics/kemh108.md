...
Here, the total number of generations = 300
30 =
...
| called its | terms | . We denote the terms of a sequence by | a | 1 | , a | 2 | , a | 3 | , …, a | n | , …, etc., the |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| subscripts denote the position of the term. The | n | th | term is the number at the | n | th | position |
| of the sequence and is denoted by | a | n | . | The | n | th | term is also called the | general |
...
*a*23 = 46 = 2 × 23, *a*24 = 48 = 2 × 24, and so on.

| In fact, we see that the | n | th | term of this sequence can be written as | a | n | = | 2 | n | , |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

where *n* is a natural number. Similarly, in the sequence of odd natural numbers 1,3,5, …,
| the | n | th | term is given by the formula, | a | n | = 2 | n | – 1, where | n | is a natural number. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| In the sequence of primes 2,3,5,7,…, we find that there is no formula for the | n | th |
| --- | --- | --- |
...
the terms *a*1, *a*2, *a*3,…,*a**n*,… in succession.
...
Let *a*1, *a*2, *a*3,…,*a**n*, be a given sequence. Then, the expression
*a*1 + *a*2 + *a*3 +,…*+ a**n**+* ...
...
| --- | --- | --- | --- | --- |
| indicating the summation involved. Thus, the series | a | 1 | + a | 2 | + | a | 3 | + ... + | a | n | is abbreviated |
...
| Find the indicated terms in each of the sequences in Exercises 7 to 10 whose | n | th |
| --- | --- | --- |
...
**11.**
*a*1 = 3, *a**n* = 3*a**n*– 1 + 2 for all *n* > 1
**12.**
*a*1 = – 1, *a**n**=*
...
as G.P.
| A sequence | a | 1 | , | a | 2 | , | a | 3 | , …, | a | n | , … is called | geometric progression | , if each term is |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
+ 1 = *r* (constant), for *k* ≥ 1.

| By letting | a | 1 | = | a | , we obtain a geometric progression, | a | , | ar | , | ar | 2 | , | ar | 3 | ,…., where | a |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| As in case of arithmetic progression, the problem of finding the | n | th | term or sum of | n |
| --- | --- | --- | --- | --- |
...
| a | by | r | , thus | a | 2 | = | ar | . Similarly, third term is obtained by multiplying | a | 2 | by | r | . Thus, |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

*a*3 = *a*2*r* = *ar*2, and so on.
We write below these and few more terms.
| 1 | st | term = | a | 1 | = | a | = | ar | 1–1 | , 2 | nd | term = | a | 2 | = | ar | = | ar | 2–1 | , 3 | rd | term = | a | 3 | = | ar | 2 | = | ar | 3–1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

| 4 | th | term = | a | 4 | = | ar | 3 | = | ar | 4–1 | , 5 | th | term = | a | 5 | = | ar | 4 | = | ar | 5–1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
***8.4.2.***
| Sum to n terms of a G .P. | Let the first term of a G.P. be | a | and the common |
| --- | --- | --- | --- |
| ratio be | r | . Let us denote by S | n | the sum to first | n | terms of G.P. Then |

S*n* = *a* + *ar* + *ar*2 +...+*ar**n*–1
... (1)
**Case 1**
| If | r | = 1, we have  S | n | = | a | + | a | + | a | + ... + | a | ( | n | terms) | = | na |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
... (2)
| Subtracting (2) from (1), we get (1 – | r | ) S | n | = | a | – | ar | n | = | a | (1 – | r | n | ) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
=
−
**Example 4** Find the 10th and *n*th terms of the G.P. 5, 25,125,… .
| Solution | Here | a | = 5 and | r | = 5. Thus, | a | 10 | = 5(5) | 10–1 | = 5(5) | 9 | = 5 | 10 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

and
*a**n* = *ar**n*–1 = 5(5)*n*–1 = 5*n* .
...
| Solution | Let 131072 be the | n | th | term of the given G.P. Here | a | = 2 and | r | = 4. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| So that | n | – 1 = 8, i.e., | n | = 9. Hence, 131072 is the 9 | th | term of  the G.P. |
| --- | --- | --- | --- | --- | --- | --- |

| Example 6 | In a G.P., the 3 | rd | term is 24 and the 6 | th | term is 192.Find the 10 | th | term. |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
**Example 8** How many terms of the G.P.
3 3
3 2 4
*,* *,*
...
Thus, the three terms of G.P. are : 4
–3
–4
, 1,
for  =
...
and *b* is the number
*ab* . Therefore, the geometric mean of 2 and 8 is 4. We
...
| Let G | 1 | , | G | 2 | , | … | , G | n | be | n | numbers between positive numbers | a | and | b | such that |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| a | ,G | 1 | ,G | 2 | ,G | 3 | , | … | ,G | n | , | b | is a G.P. Thus, | b | being the ( | n | + 2) | th | term,we have |
...
is a G.P.
| Solution | Let G | 1 | , G | 2 | ,G | 3 | be three numbers between 1 and 256 | such that |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

1, G1,G2,G3 ,256 is a G.P.
Therefore
256 = *r*4 giving*r* = ± 4 (Taking real roots only)
| For | r | = 4, we have G | 1 | = | ar | = 4, G | 2 | = | ar | 2 | = 16, G | 3 | = | ar | 3 | = 64 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
*ab* = 64
... (4)
| Putting the value of | a | and | b | from (3), (4) in the identity ( | a | – | b | ) | 2 | = ( | a | + | b | ) | 2 | – 4 | ab | , |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**1.**
| Find the 20 | th | and | n | th | terms of the G.P. | 5 | 5 | 5 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**17.**
| If the 4 | th | , 10 | th | and 16 | th | terms of a G.P. are | x, y | and | z | , respectively. Prove that | x, |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**20.**
| Show that the products of the corresponding terms of the sequences | a, ar, ar | 2 | , |
| --- | --- | --- | --- |

*…ar**n*– 1 and A, AR, AR2, … AR*n –* 1 form a G.P, and find the common ratio.
**21.**
...
*a**q – r**b**r – p**c**P – q* = 1.
**23.**
| If the first and the | n | th | term of a G.P. are | a | and | b | , respectively, and if P is the |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
end of 2nd hour, 4th hour and *n*th hour ?
...
**32.**
If A.M. and G.M. of roots of a quadratic equation are 8 and 5, respectively, then
obtain the quadratic equation.

***Miscellaneous Examples***

**Example 14** If *a, b, c, d* and *p* are different real numbers such that
| ( | a | 2 | + | b | 2 | + | c | 2 | ) | p | 2 | – 2( | ab | + | bc | + | cd | ) | p | + ( | b | 2 | + | c | 2 | + | d | 2 | ) | ≤ | 0, then show that | a, b, c | and | d |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| = ( | a | 2 | p | 2 | – 2 | abp | + | b | 2 | ) + ( | b | 2 | p | 2 | – 2 | bcp | + | c | 2 | ) + ( | c | 2 | p | 2 | – 2 | cdp | + | d | 2 | ), |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**5.**
A  G.P. consists of an even number of terms. If the sum of all the terms is 5 times
...
Prove that P2R*n* = S*n*.
**8.**
| If | a, b, c, d | are in G.P, prove that ( | a | n | + | b | n | ), ( | b | n | + | c | n | ), ( | c | n | + | d | n | ) are in G.P. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

**9.**
| If | a | and | b | are the roots of | x | 2 | – 3 | x | + | p | = 0 and | c, d | are roots of | x | 2 | – 12 | x | + | q | = 0, |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ® | Let | a | 1 | , a | 2 | , a | 3 | , ... be the sequence, then the sum expressed as | a | 1 | + | a | 2 | + | a | 3 | + ... |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| common ratio by | r | . The general or the | n | th | term of G.P. is given by | a | n | = | ar | n | – 1 | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

The sum S*n* of the first *n* terms of G.P. is given by
