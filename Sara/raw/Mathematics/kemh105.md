...
| buys, then the total amount spent by him is | ` | 30 | x | . Since, he has to buy rice in packets |
| --- | --- | --- | --- | --- |
...
(i)
| When | x | is a natural number, in this case | the following values of | x | make the |
| --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| lengths of the second and third piece, respectively. Thus, | x | + ( | x | + 3) + 2 | x | ≤ | 91 and |
...
| Solution | In this case, we have two inequalities, – 8 | ≤ | 5 | x | – 3 and 5 | x | – 3 < 7, which we |
| --- | --- | --- | --- | --- | --- | --- | --- |
| will solve simultaneously.  We have  – 8 | ≤ | 5 | x | –3 < 7 |

or
–5 ≤ 5*x* < 10
or    –1 ≤ *x* < 2

**Example 10** Solve – 5 ≤ 5
*–* *x*  ≤ 8.
...
**12.**
A solution of 8% boric acid is to be diluted by adding a 2% boric acid solution to
...
**13.**
How many litres of water will have to be added to 1125 litres of the 45% solution
