...
v***Let the relation of knowledge to real life be very visible to your pupils***
...
**(a)**
When β = 90o,  the section is a *circle* (Fig10.4).
**(b)**
| When | α | < | β | <  90 | o | , the section is an | ellipse | (Fig10.5). |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

**(c)**
When β = α; the section is a *parabola* (Fig10.6).
(In each of the above three situations, the plane cuts entirely across one nappe of
the cone).

**(d)**
When 0 ≤ β < α; the plane cuts through both the nappes and the curves of
...
**(a)**
When α < β ≤ 90o, then the section is a point (Fig10.8).

**(b)**
When β = α, the plane contains a generator of the cone and the section is a
straight line  (Fig10.9).
It is the degenerated case of a parabola.

**(c)**
When 0 ≤ β < α, the section is a pair of intersecting straight lines (Fig10.10).
...
whose centre is on the line *x*– 3*y* – 11 = 0.
...
**13.**
| Find the equation of the circle passing through (0,0) and making intercepts | a | and |
| --- | --- | --- |
...
| vertex at the origin, focus at ( | a | ,0) and directrix | x | = – | a | is | y | 2 | = 4 | ax | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Fig 11.15 (b) as *y*2 = – 4*ax*,
Fig 11.15 (c) as *x*2 = 4*ay*,
Fig 11.15 (d) as *x*2 = – 4*ay*,
...
| To find the Length of the latus rectum of the parabola | y | 2 | = 4 | ax | (Fig 10.18). |
| --- | --- | --- | --- | --- | --- |
...
| y | 2 | = 4 | ax | or | y | 2 | = – 4 | ax | . Since the directrix is | x | = – 2 and the focus is (2,0), the parabola |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

is to be of the form *y*2 = 4*ax* with *a* = 2. Hence the required equation is
*y*2 = 4(2)*x* = 8*x*
...
*x*2 = 4*ay*. thus, we have
*x*2 = 4(2)*y*, i.e.,*x*2 = 8*y.*
...
| --- | --- | --- | --- |
| the equation is of the form | x | 2 | = 4 | ay | or | x | 2 | = – 4 | ay | , where the sign depends on whether |
...
| Let F | 1 | and F | 2 | be the foci and O be the mid-point of the line segment F | 1 | F | 2 | . Let O |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| x | -axis be the | y | -axis. Let the coordinates of F | 1 | be |
| --- | --- | --- | --- | --- | --- |
...
Similarly, we can derive the equation of the ellipse in Fig 10.24 (b) as
...
| minor axes and the eccentricity of the ellipse  9 | x | 2 | + 4 | y | 2 | = 36. |
| --- | --- | --- | --- | --- | --- | --- |
...
Hence the foci are (0, 5 )  and (0, –
5 ), vertices are (0,3) and (0, –3), length of the
...
by 2*a* and we define the quantity *b* as

*b*  =
*c* *– a*

Also 2*b* is the length of the conjugate axis
(Fig 10.28).

**To find the constant P****1****F****2****– P****1****F****1****:**
...
| So that, | BF | 1 | – BF | 2 | =  BA + AF | 1 | – BF | 2 | = BA = 2 | a |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
In that case P F2 – PF1 = 2*a*. So, any point that satisfies
...
have for every point (*x*,*y*) on the hyperbola,
...
i.e,  *a*
*x*  ≥ 1, i.e., *x* ≤ – *a*  or *x* ≥ *a*.   Therefore, no portion of the curve lies between the

lines *x* = +*a* and *x* = –*a,* (i.e. no real intercept on the conjugate axis).

Similarly, we can derive the equation of the hyperbola in Fig 11.31 (b) as
...
| Also, since foci are (0, | ± | 3); | c | = 3  and | b | 2 | = | c | 2 | – | a | 2 | = | 25 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**12.** Foci (± 3
5 , 0), the latus rectum is of length 8.
...
100 m. Coordinates of B are (*x*, 2
...
**8.**
| An equilateral triangle is inscribed in the parabola | y | 2 | = 4 | ax | , where one vertex is |
| --- | --- | --- | --- | --- | --- |
...
| ® | Length of the latus rectum of the parabola | y | 2 | = 4 | ax | is 4 | a | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| His formula for finding angle between two lines was tan | θ |
| --- | --- |
...
Lame, a civil engineer, gave *m*E + *m*′E′ = 0 as the curve passing through the
