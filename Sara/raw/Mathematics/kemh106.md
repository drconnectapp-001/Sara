v***Every body of discovery is mathematical in form because there is no***
...
| Let us name the three pants as P | 1 | , P | 2 | , P | 3 | and the two shirts as S | 1 | , S | 2 | . Then, |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| school. If we name the 2 school bags as B | 1 | , B | 2 | , the three tiffin boxes as T | 1 | , T | 2 | , T | 3 | and |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
(i)
the event of choosing a pant
(ii)
the event of choosing a shirt.
...
(i)
the event of choosing a school bag
(ii)
the event of choosing a tiffin box
(iii)
the event of choosing a water bottle.
...
Therefore,
the required no of signals = 20 + 60 + 120 + 120 = 320.
...
*n*( *n* – 1) (*n* – 2) ... (*n*– *r* + 1)
This expression for *n*P*r* is cumbersome and we need a notation which will help to
...
**6.3.3*****Derivation of the formula for******n******P******r***
...
formula for *n*P*r* to illustrate its usefulness.
| In Example 1, the required number of words = | 4 | P | 4 | = 4! = 24. Here repetition is |
| --- | --- | --- | --- | --- |
...
3!
=
= 4 × 5 × 6 = 120. Here, in this case also, the repetition is not
...
| Let us treat, temporarily, the 2 Os as different, say, O | 1 | and O | 2 | . The number of |
| --- | --- | --- | --- | --- |

permutations of 4-different letters, in this case, taken all at a time
| is 4!. Consider one of these permutations say, RO | 1 | O | 2 | T | . | Corresponding to this |
| --- | --- | --- | --- | --- | --- | --- |
| permutation,we have 2 ! permutations RO | 1 | O | 2 | T and RO | 2 | O | 1 | T which will be exactly the |
| same permutation if O | 1 | and O | 2 | are not treated as different, i.e., if O | 1 | and O | 2 | are the |
...
3 times.
| Temporarily, let us treat these letters different and name them as I | 1 | , I | 2 | , T | 1 | ,  T | 2 | , T | 3 | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

The number of permutations of 9 different letters, in this case, taken all at a time is 9 !.
| Consider one such permutation, say, I | 1 | NT | 1 | SI | 2 | T | 2 | U E T | 3 | .  Here if I | 1 | , I | 2 | are not same |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

110       MATHEMATICS

| and T | 1 | , T | 2 | , T | 3 | are not same, then I | 1 | , I | 2 | can be arranged in 2! ways and T | 1 | , T | 2 | , T | 3 | can |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

be arranged in 3! ways. Therefore, 2! × 3! permutations will be just the same permutation
| corresponding to this chosen permutation I | 1 | NT | 1 | SI | 2 | T | 2 | UET | 3 | . Hence, total number of |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Theorem 4 | The number of permutations of | n | objects, where | p | 1 | objects are of one |
| --- | --- | --- | --- | --- | --- | --- |
| kind | , p | 2 | are of second kind, ..., | p | k | are of | k | th | kind and the rest, if any, are of different |
...
Therefore, the required number of arrangements = 9!
5 6 7 8 9
4!2!
× × × ×
=
...
| count the permutations of 6 digits taken 3 at a time. This number would be | 6 | P | 3 | . But, |
| --- | --- | --- | --- | --- |
...
| number of such numbers has to be subtracted from | 6 | P | 3 | to get the required number. To |
| --- | --- | --- | --- | --- |

get the number of such numbers, we fix 0 at the 100’s place and rearrange the remaining
| 5 digits taking 2 at a time. This number is | 5 | P | 2 | . So |
| --- | --- | --- | --- | --- |
...
**Example 13** Find *r*, if  5 4P*r* = 6 5P*r*–1 .
...
**Solution** (i)
There are 8 different letters in the word DAUGHTER, in which there
...
| of these 6 objects taken all at a time. This number would be | 6 | P | 6 | = 6!. Corresponding to |
| --- | --- | --- | --- | --- |
...
(ii)
If we have to count those permutations in which all vowels are never
...
(iv)
Let us fix I and P at the extreme ends (I at the left end and P at the right end).
...
**4.**
Find the number of 4-digit numbers that can be formed using the digits 1, 2, 3, 4,
...
**9.**
How many words, with or without meaning can be made from the letters of the
...
objects taken *r*at a time, denoted by *n*C*r*..
...
| of 4 different objects taken 2 at a time, i.e., | 4 | C | 2 | = 6. |
| --- | --- | --- | --- | --- |
...
| CDE, ACE, ACD, ADE, BDE. Corresponding to each of these | 5 | C | 3 | combinations, there |
| --- | --- | --- | --- | --- |
...
| Proof | Corresponding to each combination of | n | C | r | , we  have | r | ! permutations, because |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
is *n*C*r* ×*r*!. On the other hand, it is P
*n*
...
**2.**
| We define | n | C | 0 | = 1, i.e., the | number | of combinations of | n | different things taken |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| is only one way of doing so. This way we define | n | C | 0 | = 1. |
| --- | --- | --- | --- | --- |
...
**5.**
| n | C | a | = | n | C | b | ⇒ | a | = | b | or | a | = | n | – | b, | i.e., | n | = | a | + | b |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
taken 3 at a time. Hence, the required number of ways =
...
| Now, 1 man can be selected from 2 men in | 2 | C | 1 | ways and 2 women can be |
| --- | --- | --- | --- | --- |
...
| 13 | C | 4 | ways of choosing 4 clubs, | 13 | C | 4 | ways of choosing 4 spades and | 13 | C | 4 | ways of |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

choosing 4 hearts. Therefore
| The required number of ways | = | 13 | C | 4 | + | 13 | C | 4 | + | 13 | C | 4 | + | 13 | C | 4 | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
(ii)
There are13 cards in each suit.

Therefore, there are 13C1 ways of choosing 1 card from 13 cards of diamond,

| 13 | C | 1 | ways of choosing 1 card from 13 cards of hearts, | 13 | C | 1 | ways of choosing 1 |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
(iii)
There are 12 face cards and 4 are to be selected out of these 12 cards. This can be

done in 12C4 ways. Therefore, the required number of ways =
...
(iv)
There are 26 red cards and 26 black cards. Therefore, the required number of
ways = 26C2 ×
26C2
...
(v)
| 4 red cards can be selected out of 26 red cards in | 26 | C | 4 | ways. |
| --- | --- | --- | --- | --- |
| 4 black cards can be selected out of 26 black cards in | 26 | C | 4 | ways. |

| Therefore, the required number of ways = | 26 | C | 4 | + | 26 | C | 4 |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
**4.**
In how many ways can a team of 3 boys and 3 girls be selected from 5 boys and
4 girls?
**5.**
Find the number of ways of selecting 9 balls from 6 red balls, 5 white balls and 5
...
**9.**
In how many ways can a student choose a programme of 5 courses if 9 courses
...
| The number of ways of selecting 3 vowels out of 4 = | 4 | C | 3 | = 4. |
| --- | --- | --- | --- | --- |
| The number of ways of selecting 2 consonants out of 4 = | 4 | C | 2 | = 6. |
...
| selected. 5 boys out of 7 boys can be selected in | 7 | C | 5 | ways. Therefore, the required |
| --- | --- | --- | --- | --- |
...
| 1 boy and 4 girls can be selected in | 7 | C | 1 | × | 4 | C | 4 | ways. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

| 2 boys and 3 girls can be selected in | 7 | C | 2 | × | 4 | C | 3 | ways. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

| 3 boys and 2 girls can be selected in | 7 | C | 3 | × | 4 | C | 2 | ways. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

| 4 boys and 1 girl can be selected in | 7 | C | 4 | × | 4 | C | 1 | ways. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 3 girls and 2 boys can be selected in | 4 | C | 3 | × | 7 | C | 2 | ways. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4 girls and 1 boy can be selected in | 4 | C | 4 | × | 7 | C | 1 | ways. |
...
the required number of words = 5!
2! =
.
...
The number of 7-digit arrangements, clearly,

7!
3! 2! =
. But, this will include those
...
× G × G × G × G × G ×.
| There are 6 cross marked places and the three boys can be seated in | 6 | P | 3 | ways. |
| --- | --- | --- | --- | --- |
...
**1.**
How many words, with or without meaning, each of 2 vowels and 3 consonants
...
**4.**
If the different permutations of all the letter of the word EXAMINATION are
...
| repetition is not allowed, is denoted by | n | P | r | and is given by | n | P | r | = |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ® | The number of permutations of | n | objects taken all at a time, where | p | 1 | objects |
| --- | --- | --- | --- | --- | --- | --- |

124       MATHEMATICS

| are of first kind, | p | 2 | objects are of the second kind, ..., | p | k | objects are of the | k | th |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

kind and rest, if any, are all different is
...
| --- | --- | --- | --- | --- |
| to the general formulae for | n | C | r | and | n | P | r | already provided by | Mahavira, |
...
| the formula for | n | C | r | . However, he was aware that | n | C | r | = | n | C | n | – | r | for specific values |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

*n* and *r*. In 1321, *Levi Ben Gerson*, another Hebrew writer came up with the
| formulae for | n | P | r | , | n | P | n | and the general formula for | n | C | r | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
