...
a n d  d i s p r o p o r t i o n a t i o n
reactions;
...
Solution
(i) H2S is oxidised because a more
...
written as Na+Cl– (s), (Na+)2O2–(s), and (Na+)2
...
Cl– ion, –1, O2– ion, –2� and so on� �n t�eir
...
oxidation n���er o� –1, in s��eroxides
(e.g., KO2, RbO2) each oxygen atom is
assigned an oxidation n���er o� –(�)�
The second exception appears rarely, i.e.
when oxygen is bonded to fluorine. In
such compounds e.g., oxygen difluoride
(OF2) and dioxygen difluoride (O2F2), the
...
and CaH2, its oxidation n���er is –1�
5. In all its compounds, fluorine has an
oxidation n���er o� –1� Ot�er �alogens (Cl,
Br, and I) also have an oxidation number
o� –1, ��en t�e� occ�r as �alide ions in
...
carbonate ion, (CO3)2– ��st eq�al –2�
...
as oxidation n���er o� ox�gen is – 2� ��is
...
*oxidised* �ro� –2 state to +� state� ��e
...
Cu2O to decrease its oxidation number;
...
�nder section 7�2�1� �etal dis�lace�ent
...
*(b) Non-metal displacement:* The nonmetal displacement redox reactions include
...
t�at t�e �etals – zinc (�n), co��er (C�) and
...
Br– and I–, as fluorine is the strongest oxidising

agent; there is no way to convert F– ions to F2
by chemical means. The only way to achieve
F2 from F– is to oxidise electrolytically, the
...
2– reveal  the following bonding situations:
+2    0    +2
O = C = C*= C = O
Structure of C3O2
(carbon suboxide)
...
| picture is +2 for two terminal carbons and zero for the middle carbon. Likewise in Br | 3 | O | 8 | , each |
| --- | --- | --- | --- | --- |
...
16/3. In the same fashion, in the species S4O6
2–, each of the two extreme sulphurs exhibits oxidation
state of +5 and the two middle sulphurs as zero. The average of four  oxidation numbers of sulphurs
of the S4O6
2– is 2.5, whereas the reality being + 5,0,0 and +5 oxidation number respectively for
each sulphur.
...
| that particular species is present in more than one whole number oxidation states. Fe | 3 | O | 4 | , Mn | 3 | O | 4 | , |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
(d) involves disproportionation of NO2
(+4 state) into NO2
– (+3 state) and NO3
–
...
molecules (i.e. one H2O molecule) on the
left side to achieve balanced redox change.
2MnO4
–(aq) + Br–(aq) + H2O(l) → 2MnO2(s)
+ BrO3
– (aq) + 2OH–(aq)
...
wherein, Cr2O7
2– ions are reduced to Cr3+ ions.
...
+2
+3
Oxidation half : Fe2+ (aq) →  Fe3+(aq)      (7.51)
+� –2
+3
Reduction half : Cr2O7
2–(aq) →  Cr3+(aq)
(7.52)
...
half reaction, we multiply the Cr3+ by 2 to
balance Cr atoms.
...
MnO4
– concentration as low as 10–� mol dm–3
(10–� mol L–1). This ensures a minimal
...
are represented as Zn2+/Zn and Cu2+/Cu.
...
*Fig.7.3*
*The set-up for Daniell cell. Electrons*
...
Reaction (Oxidised form + *n*e–       →**Reduced form)**
E/ V
...
1.
| A negative | E |  | means that the redox couple is a stronger reducing agent than the H | + | /H | 2 | couple. |
| --- | --- | --- | --- | --- | --- | --- | --- |

2.
| A positive | E |  | means that the redox couple is a weaker reducing agent than the H | + | /H | 2 | couple. |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| (a)  KI | 3 | (b)  H | 2 | S | 4 | O | 6 | (c)  Fe | 3 | O | 4 | (d)  CH | 3 | CH | 2 | OH       (e)  CH | 3 | COOH |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
(c)
| 4BCl | 3 | (g)  +  3LiAlH | 4 | (s) | → | 2B | 2 | H | 6 | (g)  + 3LiCl(s) +  3 AlCl | 3 | (s) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
7.5
| Calculate the oxidation number of sulphur, chromium and nitrogen in H | 2 | SO | 5 | , Cr | 2 | O | 7 |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
7�7
��ggest a list o� t�e s��stances ��ere car�on can ex�i�it oxidation states �ro� –�
to +� and nitrogen �ro� –3 to +5�
...
(a)
6 CO2(g)  + 6H2O(l)  →  C6 H12 O6(aq)  + 6O2(g)
...
(a)
| 6CO | 2 | (g) + 12H | 2 | O(l) | → | C | 6 | H | 12 | O | 6 | (aq)  + 6H | 2 | O(l) + 6O | 2 | (g) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
7.10
The compound AgF2 is unstable compound. However, if formed, the compound acts
...
(a)
| 2AgBr (s) + C | 6 | H | 6 | O | 2 | (aq) | → | 2Ag(s) + 2HBr (aq) + C | 6 | H | 4 | O | 2 | (aq) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

(b)
| HCHO(l) + 2[Ag (NH | 3 | ) | 2 | ] | + | (aq) + 3OH | – | (aq) | → | 2Ag(s) +  HCOO | – | (aq) + 4NH | 3 | (aq) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

+ 2H2O(l)

(c)
| HCHO (l) + 2 Cu | 2+ | (aq) + 5 OH | – | (aq) | → | Cu2O(s) + HCOO | – | (aq) + 3H | 2 | O(l) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
XeO6
�– (aq) + 2F
– (aq) + 6H+(aq) → XeO3(g)+ F2(g) + 3H2O(l)

| What conclusion about the compound Na | 4 | XeO | 6 | (of which XeO | 6 |
| --- | --- | --- | --- | --- | --- |
...
(a)
| H | 3 | PO | 2 | (aq) + 4 AgNO | 3 | (aq) + 2 H | 2 | O(l) | → | H | 3 | PO | 4 | (aq) + 4Ag(s) + 4HNO | 3 | (aq) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

(b)
| H | 3 | PO | 2 | (aq) + 2CuSO | 4 | (aq) + 2 H | 2 | O(l) | → | H | 3 | PO | 4 | (aq) + 2Cu(s) +  H | 2 | SO | 4 | (aq) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

(c)
| C | 6 | H | 5 | CHO(l) + 2[Ag (NH | 3 | ) | 2 | ] | + | (aq) + 3OH | – | (aq) | → | C | 6 | H | 5 | COO | – | (aq) + 2Ag(s) + |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| What inference do you draw about the behaviour of Ag | + | and Cu | 2+ | from these |
| --- | --- | --- | --- | --- |

reactions ?

7�1�
�alance t�e �ollo�ing redox reactions �� ion – electron �et�od �

(a)
MnO4
– (aq) + I– (aq) →  MnO2 (s) + I2(s) (in basic medium)

(b)
MnO4
– (aq) + SO2 (g) →  Mn2+ (aq) + HSO4
...
7.21
| The Mn | 3+ | ion is unstable in solution and undergoes disproportionation to give Mn | 2+ | , |
| --- | --- | --- | --- | --- |
...
Mg2+��g � –2�37�� Cr3+�Cr � –0�7��

arrange these metals in their increasing order of reducing power.

7.30
| Depict the galvanic cell in which the reaction Zn(s) + 2Ag | + | (aq) | → | Zn | 2+ | (aq) +2Ag(s) |
| --- | --- | --- | --- | --- | --- | --- |
