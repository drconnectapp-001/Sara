...
later by his assistant Johannes Kepler (15711640). He could extract from the data three
...
*fixed at F**1**and F**2**. The tip of a pencil holds*
...
of a string and  fix its ends at F1 and F2 by
...
the sum of the distances from F1 and F2 is a
constant.  F1, F2 are called the focii. Join the
points F1 and  F2  and extend   the line to
...
D*A swept out in a small interval of time* D*t.*
...
**(a**
º
**Semi-major  axis in units of  10****10****m.**
**T**
º
...
**Q**
º
**The quotient**(**T****2****/a****3**  )**in units of**
**10****-34****y****2****m****-3****.)**
...
planet of mass m in time interval D*t* is (Fig.
7.2) D**A** given by
...
as the planet goes around. Hence,  A /D*t* is a
...
at  the  perihelion *P*in Fig. 7.1(a) be *v**P* and
the Sun-planet distance SP be *r**P*. Relate
{*r**P**, v**P*} to the corresponding quantities at
the aphelion {*r**A,**v**A*}. Will the planet take
equal times to traverse *BAC*and *CPB*?

**Answer**  The magnitude of the angular
momentum at *P* is *L**p**=  m**p**r**p**v**p*, since inspection
tells us that **r***p* and **v***p* are mutually
perpendicular. Similarly, *L**A**= m**p**r**A**v**A*. From
angular momentum conservation
*m**p**r**p**v**p* *= m**p**r**A**v**A*
...
the moon revolving in an orbit of radius *R**m* was
...

. The
time period *T* is about 27.3 days and *R**m* was
already known then to be about 3.84 × 108m.  If
we substitute these numbers in Eq. (7.3), we get
a value of *a**m* much smaller than the value of
...
the value of *a*m from Eq. (7.3).  These observations
...
law reads : The force **F**on a point mass *m**2* due
to another point mass *m**1* has the magnitude
...
ɵr  is the unit vector from *m*1 to *m*2 and **r** = **r**2 – **r**1
as shown in Fig. 7.3.

The  gravitational force is attractive, i.e., the
force **F**is along – **r**. The force on point mass *m*1
due to *m*2 is of course – **F**by Newton’s third law.
Thus, the gravitational force **F**12 on the body 1
due to 2 and **F**21 on the body 2 due to 1 are related
as **F**12 = –***F***21.
...
***Fig. 7.4*** *Gravitational force on point mass m**1**is the*
...
***Fig. 7.3***
*Gravitational force on m*1*due to m*2*is along*
**r***where the vector***r***is (***r**2*–***r**1*).*
...
**Fig. 7.6**
*Schematic drawing of Cavendish’s*
...
*Fig. 7.7*
*The mass m is in a mine located at a depth*
...
its mass *M**r*is concentrated at the centre.  Thus
...
where *M**E* is the mass of the earth *R**E* is its radius
and ρ is the density.  On the other hand the

mass of the sphere *M**r*of radius *r* is
...
earth, then  *r*=*R**E* and the gravitational force on
it is, from Eq. (7.10)
...
Acceleration *g* is readily measurable.  *R**E* is a
known quantity.  The measurement of *G* by
Cavendish’s experiment (or otherwise), combined
with knowledge of *g* and *R**E* enables one to
estimate *M**E* from Eq. (7.12).  This is the reason
...
radius of the earth is denoted by  *R**E**.* Since this
point is outside the earth,

*Fig. 7.8 (a)*
*g at a height h above the surface of the*
*earth.*
...
at the centre. If *M**s*  is the mass of the smaller
sphere, then,
*M**s**/M**E**= (* *R**E**–* d)3  /*R**E*
( 7.16)
...
***Fig. 7.8 (b)***
*g at a depth d. In this case only the smaller*
*sphere of radius (R**E**–d) contributes to g.*
...
point at a height *h*1 from the surface of the earth
and another point vertically above it at a height
*h*2 from the surface, the work done in lifting the
particle of mass *m* from the first to the second
position is denoted by *W*12
...
constant *W*o cancels out in Eq. (7.22).  Setting  *h*
= 0 in the last equation, we get   *W* ( *h* = 0 ) =  *W*o.
.  *h* = 0 means points on the surface of the earth.
Thus,  *W*o  is the  potential energy on the surface
of the earth.
...
W ( *r* = infinity ) =   *W*1 .   Thus,  *W*1  is the potential
...
(7.24). One conventionally sets  *W*1 equal to zero,
...
of masses *m*1 and *m*2 separated by distance by a
...
V*f*. The energy of an object is the sum of potential
and kinetic energy. As before *W*1 denotes that
...
*V**i* from a point at a distance (*h*+*R**E*) from the
centre of the earth (*R**E* = radius of the earth), its
...
Thus, an object can reach infinity as long as V*i*
is such that
...
The minimum value of V*i* corresponds to the
...
Using the value of *g* and *R**E*, numerically
(*V**i*)min≈11.2 km/s. This is called the escape
...
gravity on its surface and *r**E* replaced by the
...
6*R*– *r =* ±2*r*
*r* *=* 2*R*or – 6*R.*
The neutral point *r =*  – 6*R*does not concern
...
the greater gravitational pull of 4*M*would
...
of a distance (*R**E* + *h* ) from the centre of the earth,
where *R**E* = radius of the earth. If *m* is the mass
...
traverses a distance 2p(*R**E* + *h*) with speed *V*.  Its
...
*T**2**= k  ( R**E**+ h)**3**(where k = 4*p*2**/ GM**E**)*    (7.38)
...
be neglected in comparison to *R**E* in Eq. (7.38).
...
g ≃ 9.8 m s-2 and *R**E* = 6400 km., we get
...
circular. For example, the ratio of the semiminor to semi-major axis for our Earth is,
*b/a*= 0.99986.
⊳

**Example 7.6**   **Weighing the Earth** : You
are given the following data: *g* *=*9.81 ms–2,
*R**E**=*6.37´106 m, the distance to the moon *R*
*=*3.84´108 m and the time period of the
moon’s revolution is 27.3 days. Obtain the
mass of the Earth*M**E* in two different ways.
...
orbits if we replace (*R**E*+*h*) by the semi-major axis
...
(R
e+h) from the centre of the earth is
...
| where | G | is the universal gravitational constant, which has the value  6.672 | × | 10 | –11 | N m | 2 | kg | –2 | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

2. If we have to find the resultant gravitational force acting on the particle m due to a number of
| masses | M | 1 | , | M | 2 | , …. | M | n | etc. we use the principle of superposition. Let | F | 1 | , | F | 2 | , …. | F | n | be the individual |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

forces due to *M**1*, *M**2*, ….*M**n*, each given by the law of gravitation. From the principle of superposition
| each force acts independently  and uninfluenced by the other bodies. The resultant force | F | R | is |
| --- | --- | --- | --- |
...
orbit of radius 2*R**E* about the Earth. How much
energy is required to transfer it to a circular
orbit of radius 4*R**E*? What are the changes in
...
| 3. | In Kepler’s third law (see Eq. (7.1) and | T | 2 | = K | S | R | 3 | . The constant | K | S | is the same for all |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| mg | ( | r | 2 | – | r | 1 | ) for the difference of potential energy between two points | r | 2 | and | r | 1 | distance |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| revolution ? Take the diameter of the Milky Way to be 10 | 5 | ly. |
| --- | --- | --- |
...
| centre is the gravitational force on the rocket zero ? Mass of the sun = 2 | × | 10 | 30 | kg, |
| --- | --- | --- | --- | --- |

mass of the earth = 6×1024 kg. Neglect the effect of other planets etc. (orbital radius
= 1.5 × 1011 m).
**7.13**
How will you ‘weigh the sun’, that is estimate its mass? The mean orbital radius of
the earth around the sun is 1.5 × 108 km.
**7.14**
A saturn year is 29.5 times the earth year. How far is the saturn from the sun if the
earth is 1.50 × 108 km away from the sun ?
**7.15**
A body weighs 63 N on the surface of the earth. What is the gravitational force on it
due to the earth at a height equal to half the radius of the earth ?

GRAVITATION

7.16
Assuming the earth to be a sphere of uniform mass density, how much would a
...
| = 6.0 | × | 10 | 24 | kg; mean radius of the earth = 6.4 | × | 10 | 6 | m; | G | = 6.67 | × | 10 | –11 | N m | 2 | kg | – | 2 | . |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

7.18
| The escape speed of a projectile on the earth’s surface is 11.2 km s | –1 | . A body is |
| --- | --- | --- |
...
| influence? Mass of the satellite = 200 kg; mass of the earth = 6.0 | × | 10 | 24 | kg;  radius  of |
| --- | --- | --- | --- | --- |
...
of *G*).
7.21
Two heavy spheres each of mass 100 kg and radius 0.10 m are placed 1.0 m apart on
