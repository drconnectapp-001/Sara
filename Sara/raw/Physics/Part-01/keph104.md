...
to constantly drag the string attached to the toycar with some force to keep it going.  If it releases
...
(iii) Motion on a horizontal plane  is an intermediate situation.  Galileo concluded that an object
...
inertia was his starting point which he formulated as the first law of motion*:*
...
**Fig. 4.2**
(a)*a book at rest on the table, and*(b)*a car*
...
**Fig. 4.3**
*Force not only depends on the change in*
...
**Fig. 4.5**
*Acceleration at an instant is determined by*
...
of two bodies as a whole, **F***AB* and **F***BA* are
...
Note,  while *p**x* changes sign  after collision,  *p**y*
does not.  Therefore,
...
in momentum of the bullet and *–***F** ∆*t* is the
change in momentum of the gun. Since initially,
both are at rest, the change in momentum equals
the final momentum for each. Thus if **p***b* is the
momentum of the bullet after firing and **p***g* is the
recoil momentum of the gun, **p***g**= –***p***b**i.e.* **p***b**+* **p***g*
...
initial momenta **p***A* and **p***B*. The bodies collide,
...
uniform motion.
If two forces **F**1 and **F**2, act on a particle,
...
concurrent forces **F**1, **F**2  and **F**3 requires that
...
say **F**1 and **F**2, obtained by the parallelogram
law of forces must be equal and opposite to the
third force, **F**3.  As seen in Fig. 4.7, the three
...
is in equilibrium under the action of forces **F**1,
**F**2,... **F**n if they can be represented by the sides
...
where *F*1x, *F*1y and *F*1z are the components of *F*1
along *x*, *y* and *z* directions respectively.

**Example 4.6**  See Fig. 4.8. A mass of 6 kg
is suspended by a  rope  of  length 2 m
from the ceiling.  A force of 50 N in the
horizontal direction is  applied  at  the midpoint P of the rope, as shown. What is the
...
Clearly,*T*2 = 6 × 10 = 60 N.

Consider the equilibrium of the point P under
the action of three forces - the tensions *T*1 and
*T*2, and the horizontal force 50 N.  The horizontal
...
since we are talking of uncharged and nonmagnetic bodies in mechanics. At the microscopic
...
This force *f**s* parallel to the surface of the body in
...
it from kinetic friction *f**k* that we consider later
...
force *F* increases, *f**s* also increases, remaining
...
contact. The constant µ*s*  is called the coefficient
...
*s**f*
the body
begins to slide on the surface. It is found experimentally that when relative motion has started,
...
denoted by fk .  Kinetic friction, like static friction, is found to be independent of the area of
...
mentioned above, experiments show that µ*k* is
less than µ*s*. When relative motion has begun,
the acceleration of the body according to the
second law is *( F – f**k**)/m.*  For a body moving with
constant velocity, *F = f**k*. If the applied force on
the body is removed, its acceleration is *– f**k**/m*
...
opposed by the static friction *f**s*. Static friction
...
*ma  =  f**s* ≤ µ*s**N  =*µ*s**m g*
*i.e.   a*≤  µ*s**g*
∴*a**max**=*µ*s**g  =* 0.15  x 10 m s–2
...
static frictional force *f**s* opposing the impending
...
*m g* sin θ  *=  f**s**,* *m g*  cos θ  *=  N*

As θ  increases, the self-adjusting frictional force
*f**s* increases until at θ *=*θ*max*,*f**s* achieves its
...
When  θ  becomes just a little more than  θ*max* ,
there is a small net force on the block and it
begins to slide.  Note that  θ*max* depends only on
µ*s* and is  independent of the mass of the block.
...
speed *v* is *v*2/*R* directed towards the centre.
...
This shows that for a given value of µ*s* and *R*,
...
equation also tells you that for *v < v**o*, frictional
force will be up the slope and that a car can be
parked only if tan θ  ≤  µ*s*.
...
Now, *R =*3 m*,  g*= 9.8 m s-2,  µ*s* = 0.1.  That is,
µ*s**R g*= 2.94 m2 s-2*. v =*18  km/h*=*5  m s-1*;*i.e.,
*v*2 = 25  m2 s-2.  The condition is not obeyed.
...
what is the (a) optimum speed of the racecar to avoid wear and tear on its tyres, and
...
is not needed.  The optimum speed *v**o* is given by
Eq.  (4.22):
*v**O**=  (R g* tan θ*)*1/2
...
The maximum permissible speed *v**max* is given by
Eq. (4.21):
...
For (a):
(i) the force of gravity (20 N) on the block
...
floor (reaction).
For (b):
(i) the force of gravity (270 N) on the
...
force on the mass by the floor are not actionreaction pairs. These forces happen to be equal
...
a whole.
(d)
F at a point at a certain instant determines a at the same point at that instant.
...
tangent to the surface in contact.  Static friction *f**s* opposes impending relative
motion; kinetic friction *f**k* opposes actual relative motion. They are independent
...
µ*s* (co-efficient of static friction) and µ*k* (co-efficient of kinetic friction) are
constants characteristic of the pair of surfaces in contact.  It is found
experimentally that µ*k* is less than µ*s* .

POINTS TO PONDER

1.
Force is not always in the direction of motion.  Depending on the situation, F
may be along v, opposite to v, normal to v or may make some other angle with
v.  In every case, it is parallel to acceleration.
2.
If v = 0 at an instant, i.e. if a body is momentarily at rest, it does not mean that
...
3.
Force on a body at a given time is determined by the situation at the location of
...
4.
In the second law of motion F*= m*a, F stands for the net force due to all
| material agencies external to the body. | a | is the effect of the force. | m | a | should |
| --- | --- | --- | --- | --- | --- |

not be regarded as yet another force, besides F.

5.
The centripetal force should not be regarded as yet another kind of force. It is
...
6.
| Static friction is a self-adjusting force up to its limit | m | s | N (f | s | £ m | s | N) | .  Do not put |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |

*f**s**=* m*s**N*  without being sure that the maximum value of static friction is coming
into play.
7.
The familiar equation *mg = R*for a body on a table is true only if the body is in
...
law.
8.
The terms ‘action’ and ‘reaction’ in the third Law of Motion simply stand for
...
9.
The different terms like ‘friction’, ‘normal reaction’, ‘tension’, ‘air resistance’,
...
(e)
a high-speed electron in space far from all material objects, and free of
...
(c)
at the highest point where it is momentarily at rest.  Do your answers
...
4.6
A constant force acting on a body of mass 3.0 kg changes its speed from 2.0 m s-1
