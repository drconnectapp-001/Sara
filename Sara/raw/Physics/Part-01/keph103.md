...
(space), we need to use vectors to describe the abovementioned physical quantities.  Therefore, it is first necessary
...
(b)*Displacement vector***P****Q***and different*
*courses of motion.*
...
displacement vector is the same **P****Q** for different
...
*unchanged. Such vectors are called f*ree vectors. *However, in some physical applications, location or line of*
...
*Fig. 3.3*
(a)*Vector*A *and the resultant vector after*
...
| Fig. 3.5 | (a) | Two vectors | A | and | B | , – | B | is also shown. | (b) | Subtracting vector | B | from vector | A | – | the result is | R | 2 | . For |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
vector A to get R2 = (A – B). The vector R1 = A + B
...
are represented by the vectors **v****r** and **v****w** in      Fig.
3.7 and are in the direction specified by the
problem.  Using the rule of vector addition, we
see that the resultant of **v****r** and **v****w** is **R** as shown
...
The direction q  that *R* makes with the vertical
is given by
...
**Fig. 3.6**
| (a) | Two vectors | A | and | B | with their tails brought to a common origin. | (b) | The sum | A | + | B | obtained using |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
But since **O****Q** is parallel to **a**, and **Q****P** is parallel
to **b**, we can write :

**O****Q** = l **a**, and **Q****P**= *µ* **b**
(3.7)

where  l and *µ* are real numbers.
...
component vectors l **a**and m **b**along **a**and **b**

| Fig. 3.9 | (a) | Unit vectors | ɵ | i | , | ɵ | j | and | k | ɵ | lie along the x-, y-, and z-axes. | (b) | A vector | A | is resolved into its |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| components A | x | and A | y | along x-, and y- axes. | (c) | A | 1 | and | A | 2 | expressed in terms of | ɵ | i | and | ɵ | j | . |
...
denoted by ɵi , ɵj and ˆk , respectively, as shown
in Fig. 3.9(a).
...
say ˆn by a scalar, the result is a vector

λ = λ ˆn.  In general, a vector A can be written as

A = |A| ˆn
(3.10)

where ˆn is a unit vector along A.

We can now resolve a vector A in terms
of component vectors that lie along unit vectors

iˆ and ɵj.  Consider a vector A that lies in *x-y*
plane as shown in Fig. 3.9(b). We draw lines from
the head of A perpendicular to the coordinate
axes as in Fig. 3.9(b), and get vectors A1 and A2
such that  A1 + A2 = A. Since A1 is parallel to  ɵi
...
where *A**x* and  *A**y* are real numbers.

Thus,    A = *A**x*ɵi + *A**y* ɵj
(3.12)

This is represented in Fig. 3.9(c). The quantities
*A**x*and *A**y*are called *x-*, and *y-* components of the
vector A. Note that *A**x* is itself not a vector, but

*A**x* ɵi  is a vector, and so is *A**y*ɵj. Using simple
trigonometry, we can express *A**x*and *A**y* in terms
...
(i)
its magnitude *A* and the direction θ it makes
with the *x*-axis; or
(ii) its components *A**x* and *A**y*
If A and θ  are given,  *A**x*and *A**y*can be obtained
using Eq. (3.13). If *A**x*and *A**y* are given, *A*and θ
...
*Fig. 3.9* (d)
*A vector*A *resolved into components along*
*x-, y-, and z-axes*
...
**Answer**  Let **OP** and **O****Q** represent the two vectors
**A** and **B** making an angle q  (Fig. 3.10).  Then,
...
*ON*= *OP* + *PN*= *A* + *B*cos q
*SN*= *B*sin q
*OS**2* = (*A* + *B* cos q)2 + (*B* sin q)2

or,
*R**2* = *A**2* + *B**2* + 2*AB*  cos q
...
In D OSN,  *SN* = *OS* sina = *R* sina,  and
in D PSN,  *SN* = *PS* sin q = *B* sin q

Therefore,   *R* sin a  = *B* sin q
...
**Answer**   The vector **v****b** representing the velocity
of the motorboat and the vector **v****c** representing
...
(b)
*Fig. 3.12* (a)*Position vector*r*.*(b)*Displacement*∆r*and*
...
time *t*′ [Fig. 3.12(b)].  Then, the displacement is :
∆r  = r′ – r
(3.25)
...
times ∆*t*1,∆*t*2, and ∆*t*3. ∆r1,  ∆r2, and ∆r3 are the
displacements of the object in times  ∆*t*1, ∆*t*2, and
...
∆*t*3, respectively. The direction of the average
velocity v   is shown in figures (a), (b) and (c) for
three decreasing values of ∆*t*, i.e. ∆*t*1,∆*t*2, and ∆*t*3,
...
*v**x**, v**y* and angle θ are shown in Fig. 3.14 for a
...
time *t* and P1, P2, P3 positions after time ∆*t*1, ∆*t*2,
∆*t*3, respectively (∆*t* 1> ∆*t*2>∆*t*3). The velocity vectors
...
**Fig. 3.14** *The components v**x**and v**y**of velocity***v***and*
...
time. We follow the method used in the onedimensional case. Let ro and r be the position
...
(vo + v)/2. The displacement is the average
velocity multiplied by the time interval :

| Fig. 3.15 | The average acceleration for three time intervals | (a) | ∆ | t | 1 | , | (b) | ∆ | t | 2 | , and | (c) | ∆ | t | 3 | , ( | ∆ | t | 1 | > | ∆ | t | 2 | > | ∆ | t | 3 | ). | (d) | In the |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

*limit*∆*t*g*0, the average acceleration becomes the acceleration.*
...
launched with velocity **v**o that makes an angle
θo with  the *x*-axis as shown in Fig. 3.16.
...
of maximum height, *v**y*= 0 and therefore,
...
Now, since *g*, θo and *v*o are constants, Eq. (3.39)
is of the form *y = a x + b x*2, in which *a*and *b* are
...
maximum height ?  Let this time be denoted by *t**m*.
Since at this point, *v**y**=* 0, we have from Eq. (3.38):
*v**y**= v**o* sinθ*o**– g t**m**=*0
Or,
*t**m**= v**o* sinθ*o**/g*
(3.40a)

The total time *T**f*  during which the projectile is
...
*T**f*  is known as the**time of flight** of the projectile.
We note that *T**f*  = 2 *t**m*, which is expected
...
of flight *T**f*  . Therefore, the range *R* is
*R*= (*v**o* cos θ*o*) (*T**f*)

=(*v**o* cos θ*o*)  (2 *v**o* sin θo)/*g*
...
projection velocity *v*o , *R* is maximum when sin
2θ0 is maximum, i.e., when θ0 = 450.
...
**v****o** at an angle θo , the range is given by
...
**Answer**   We choose the origin of the *x*-,and *y*axis at the edge of the cliff and *t*= 0 s at the
...
vertically upward direction. The *x*-, and *y*components of the motion can be treated
independently. The equations of motion are :
*x (t)  = x**o**+ v**ox**t*

*y (t)  = y**o**+ v**oy*  *t +*(1/2)*a**y**t**2*

Here,
*x*o*= y*o = 0, *v*oy = 0, *a**y**=*  *–g* = –9.8 m s-2*,*
*v*ox = 15 m s-1.
...
*T**f*= (2 *v*o sin θo )/*g* = (2× 28 × sin 30° )/9.8
= 28/9.8 s = 2.9 s
...
*R* as shown in Fig. 3.18. Since the velocity of the
...
∆v is obtained in Fig. 3.18 (a2) using the triangle
...
v, v′ and ∆v are similar (Fig. 3.18a).  Therefore,
...
Therefore, the centripetal acceleration *a**c* is :
...
| * | In the limit | ∆ | t | Ž | 0, | ∆ | r | becomes perpendicular to | r | . In this limit | ∆ | v | → | 0 | and is consequently also perpendicular |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
*v*
*2**/R* and is always **directed towards the centre**.
...
We can express centripetal acceleration *a**c* in
...
frequency ν (=1/*T*).  However, during this time
the distance moved by the object is *s*= 2π*R*.
Therefore, *v* = 2π*R*/*T* =2π*R*ν
(3.47)
...
The unit vectors  ɵ ɵ
ɵ
i, j, k  are vectors of unit magnitude and point in the direction of
...
| where | A | x | , | A | y | are its components along | x- | , and | y - | axes.  If vector | A | makes an angle | θ |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

with the *x*-axis, then *A**x* = *A* cos θ, *A**y*=*A*sin θ and
...
*y*
ɵ
ɵ, where, *R**x**= A**x**+ B**x**,*and     *R**y**= A**y**+ B**y*

12.
| The | position vector | of an object in | x-y | plane is given by | r |
| --- | --- | --- | --- | --- | --- |
...
j
13.
| If an object undergoes a displacement | ∆ | r | in time | ∆ | t | , its | average velocity | is given by |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
14.
| If the velocity of an object changes from | v | to | v | ′ | in time | ∆ | t | , then its | average acceleration |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
*t*
*t*
| The | acceleration | a | at any time | t | is the limiting value of | a | as | ∆ | t | Ž | 0 : |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| its position vector at time | t | = 0 is | r | o | , then at any other time | t | , it will be at a point given |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
**v**= **v****o**+ **a** *t*
where **v****o** is the velocity at time *t*= 0
In component form :
...
16.
| An object that is in flight after being projected is called a | projectile | .  If an object is |
| --- | --- | --- |
...
| called | uniform circular motion | . The magnitude of its acceleration is | a | c | = | v | 2 | /R | . The |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

direction of *a**c* is always towards the centre of the circle.
The angular speed ω, is the rate of change of angular distance. It is related to velocity
*v*by   *v*= ω*R*.  The acceleration is *a**c* = ω 2*R*.
| If | T | is the time period of revolution of the object in circular motion and | ν | is its |
| --- | --- | --- | --- | --- |

frequency, we have ω = 2π ν, *v* = 2πνR,  *a**c* = 4π2ν2*R*
...
| 5. An object subjected to two velocities | v | 1 | and | v | 2 | has a resultant velocity | v | = | v | 1 | + | v | 2 | . Take |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| care to distinguish it from velocity of object 1 relative to velocity of object 2 : | v | 12 | = | v | 1 | − | v | 2 | . |
...
**3.8**
Three girls skating on a circular ice ground of radius
...
| 3.10 | On an open ground, a motorist follows a track that turns to his left by an angle of  60 | 0 |
| --- | --- | --- |
...
(a)
| The net acceleration of a particle in circular motion is | always | along the radius of |
| --- | --- | --- |

the circle towards the centre
(b)
The velocity vector of a particle at a point is *always* along the tangent to the path
of the particle at that point
(c)
The acceleration vector of a particle in *uniform* circular motion averaged over one
...
| 3.18 | A particle starts from the origin at | t | = 0 s with a velocity of 10.0 | j | ɵ | m/s and moves in |
| --- | --- | --- | --- | --- | --- | --- |
...
and direction of the vectors  ɵ
ɵ
i
j
+ , and ɵ
