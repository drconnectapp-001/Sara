...
more units that are defined for (a) plane angle dq as the
ratio of length of arc d*s* to the radius *r* and (b) solid
angle dW as the ratio of the intercepted area d*A* of the
...
(b)
**Fig. 1.1** *Description of (a) plane angle d*q*and*
*(b) solid angle**d*.
...
in the unit m s–1, where the second is defined in terms of the caesium
frequency Dn*cs*.
...
the unit J s, which is equal to kg m2 s–1, where the metre and the second are
defined in terms of *c* and Dn*cs*.

Time
second
s
The second is the SI unit of time. It is defined by taking the fixed numerical
value of the caesium frequency Dn*cs*, the unperturbed ground-state hyperfine
...
current
| fixed numerical value of the elementary charge | e | to be 1.602176634 | ´ | 10 | 19 |
| --- | --- | --- | --- | --- | --- |

when expressed in the unit *C*, which is equal to A s, where the second is
defined in terms of Dn*cs*.
...
| value of the Avogadro constant, | N | A | , when expressed in the unit mol | –1 | and is |
| --- | --- | --- | --- | --- | --- |
...
lm W–1, which is equal to cd sr W–1, or cd sr kg–1m–2s3, where the kilogram,
metre and second are defined in terms of *h*, *c* and Dn*cs*.
...
are given special names (Appendix A  6.2 )
...
expressed as *a* × 10*b*, where *a*is a number
...
its volume is measured to be 2.51 cm3, then its
density, by mere arithmetic division, is
1.68804780876 g/cm3 upto 11 decimal places.
...
3.00 × 108 m s-1 (three significant figure) and
...
3.00 × 10–3 m in the example of **subtraction**. They
...
in time *t*which starts from the position *x**0* with
an initial velocity *v**0* at time *t* = 0 and has uniform
...
6.
The SI units have well defined and internationally accepted unit symbols (such as m
...
| 1 kg m | 2 | s | –2 | .  Suppose we employ a system of units in which the unit of mass equals | α |
| --- | --- | --- | --- | --- | --- |
...
is a
set of 100 measurements of the diameter expected to yield a more reliable
estimate than a set of 5 measurements only ?
1.9
| The photograph of a house occupies an area of 1.75 cm | 2 | on a 35 mm slide.  The slide |
| --- | --- | --- |
| is projected on to a screen, and the area of the house on the screen is 1.55 m | 2 | .  What |
...
| 1.13 | A famous relation in physics relates ‘moving mass’ | m | to the ‘rest mass’ | m | o | of a |
| --- | --- | --- | --- | --- | --- | --- |
