...
**Fig. 10.1** *A plot of Fahrenheit temperature (t*F)*versus*
...
temperature (*t*C) in a straight line (Fig. 10.1),
whose equation is
...
this Table, compare the value of αl for glass and
...
in volume, ∆*V*
*V* , of a substance for temperature
...
alloy) having particularly low values of αV. From
this Table we find that the value of αv for
...
At 0 °C, αv = 3.7 × 10–3 K–1, which is much
larger than that for solids and liquids.
Equation (10.6) shows the temperature
dependence of αv; it decreases with increasing
temperature. For a gas at room temperature and
constant pressure, αv is about 3300 × 10–6 K–1, as
...
coefficient of volume expansion (αv) and
coefficient of linear expansion (αl). Imagine a
cube of length, *l*, that expands equally in all
directions, when its temperature increases by
∆*T*. We have
∆*l*= αl *l*∆*T*
so, ∆*V* = (*l+*∆*l*)3 – *l*3 ≃ 3*l*2 ∆*l*
(10.7)
...
strain is ∆*l*
*l* = αl(steel) ∆*T* = 1.2 × 10–5 × 10=1.2 × 10–4.

Youngs modulus of steel is *Y* (steel) = 2 × 1011 N m–2.
...
area expansion, (∆*A/A*)/∆*T*, of a
rectangular sheet of the solid is twice its
linear expansivity, αl.
...
= αl*b* ∆*T*. From Fig. 10.8,  the increase in area
∆*A* = ∆*A*1 +∆*A*2 + ∆*A*3
∆*A* = *a* ∆*b* + *b*∆*a* + (∆*a*)  (∆*b*)
= *a*αl*b* ∆*T* + *b*αl *a* ∆*T* + (αl)2 *ab* (∆*T*)2

= αl *ab* ∆*T* (2 + αl ∆*T*) = αl *A* ∆*T* (2 + αl ∆*T*)
Since αl ≃ 10–5 K–1, from Table 10.1, the
...
*L*T2 = 5.243 m
So,
*L*T2 =*L*T1 [1+αl *(T*2–*T*1)]

5.243 m = 5.231 m [1 + 1.20×10–5  K–1 (*T*2–27 °C)]
...
**constant pressure** and is denoted by *C*p. On
...
**volume** and is denoted by *C*v. For details see
...
**Table 10.4**
**Molar specific heat capacities of**
**some gases**
...
Change in temperature (∆*T*2) = 23 °C – 20 °C = 3 °C
Specific heat capacity of water (*s*w)
= 4.18 × 103 J kg–1  K–1
...
calorimeter = *m*2 *s*w ∆*T*2 + *m*3*s*cu∆*T*2
...
**Fig. 10.9**
*A plot of temperature versus time showing*
...
| --- | --- | --- | --- | --- |
| diagram or | P | – | T | diagram. The following figure shows the phase diagram of water and CO | 2 | . |
...
| Figure : | Pressure-temperature phase diagrams for (a) water and (b) CO | 2 | (not to the scale). |
| --- | --- | --- | --- |
...
J kg–1. The value of *L* also depends on the
...
**fusion** (*L*f), and that for a liquid-gas state change
is called the **latent heat of vaporisation** (*L*v).
...
fusion and vaporisation are *L*f = 3.33 × 105 J kg–1

and *L*v = 22.6 × 105 J kg–1, respectively. That is,
...
100 °C carries  22.6 × 105 J  kg–1 more heat than
...
(*s*water = 4186 J kg–1 K–1)

**Answer**

Heat lost by water = *ms*w (θf–θi)w
= (0.30 kg) (4186 J kg–1 K–1) (50.0 °C – 6.7 °C)
= 54376.14 J
Heat required to melt ice = *m*2*L*f = (0.15 kg) *L*f
Heat required to raise temperature of ice
water to final temperature = *m*I*s*w (θf–θi)I
...
specific heat capacity of ice, *s*ice
= 2100 J kg–1  K–1

specific heat capacity of water, *s*water
= 4186 J kg–1  K–1

latent heat of fusion of ice, *L*f ice
= 3.35 × 105 J kg–1
...
0 °C to water at 0 °C
*=*
*m L*f ice = (3 kg) (3.35 × 105 J kg–1)
=
1005000 J
*Q*3
=
...
with large reservoirs at temperatures, say, *T*C and
*T*D, respectively (Fig. 10.14). Let us assume the
...
distance from *T*C to *T*D; (*T*C>*T*D). The reservoir at
...
to the temperature difference (*T*C – *T*D) and the
...
respectively.  For *A*1 = 2 *A*2, *L*1 = 15.0 cm,
*L*2 = 10.0 cm, *K*1 = 50.2 J s–1 m–1 K –1, *K*2 = 385 J
s–1 m–1 K –1, we have
...
**Example 10.7** An iron bar (*L*1 = 0.1 m, *A*1 =
0.02 m 2, *K* 1 = 79 W m –1 K –1) and a
brass bar (*L*2 = 0.1 m, *A*2 = 0.02 m2,
*K*2 = 109 W m–1K–1) are soldered end to end
...
**Answer**
Given, *L*1 = *L*2= *L* = 0.1 m, *A*1 = *A*2= *A*= 0.02 m2

*K*1 = 79 W m–1 K –1, *K*2 = 109 W m–1 K–1,
*T*1 = 373 K, and *T*2 = 273 K.
Under steady state condition, the heat
current (*H*1) through iron bar is equal to the
heat current (*H*2) through brass bar.
So, *H = H*1 = *H*2
...
For *A*1 = *A*2 = *A* and *L*1 = *L*2 = *L*, this equation
leads to
*K*1 (*T*1 – *T*0) = *K*2 (*T*0 – *T*2)
Thus, the junction temperature *T*0 of the two
bars is
...
through the compound bar of length *L*1 + *L*2 = 2*L*
...
i.e., 3 × 108 m s–1 . You will learn these matters in
...
Notice that the wavelength λ*m* for which energy
is the maximum decreases with increasing
temperature. The relation between λ*m* and *T* is
...
maximum at λ*m* = 4753 Å. This corresponds to
...
10–4 × 0.4 × 5.67 × 10–8 × (3000)4 = 60 W.
A body at temperature *T*, with surroundings
at temperatures *T*s, emits, as well as, receives
...
of a person’s body is about 1.9 m2 and the room
...
*T*1 is the temperature of the surroundings.
...
(*T*2) of water till it attains a temperature about
5 °C above that of the surroundings. Then, plot

a graph by taking each value of temperature
∆*T* = *T*2 – *T*1 along y-axis and the coresponding
value of  *t* along x-axis (Fig. 10.19).
...
of loss of heat, – d*Q*/d*t* of the body is directly
proportional to the difference of temperature
∆*T* = (*T*2*–T*1) of the body and the surroundings.
...
capacity *s* is at temperature *T*2. Let *T*1 be the
temperature of the surroundings. If the
temperature falls by a small amount d*T*2 in time
d*t*, then the amount of heat lost is
d*Q* = *ms*d*T*2
...
Fig. 10.20(a). The set-up consists of a doublewalled vessel (V) containing water  between
...
temperatures *T*2 of water in calorimeter and
*T*1 of hot water in between the double walls,
respectively. Temperature of hot water in the
calorimeter is noted after equal intervals of
time. A graph is plotted between log e (*T*2–*T*1)
[or *l*n(*T*2–*T*1)] and time (*t*). The nature of the
...
3.
| The Celsius temperature ( | t | C | ) and the Farenheit temperare ( | t | F | )are related by |
| --- | --- | --- | --- | --- | --- | --- |

*t*F = (9/5) *t*C + 32

4.
| The ideal gas equation connecting pressure ( | P | ), volume ( | V | ) and absolute temperature ( | T | ) |
| --- | --- | --- | --- | --- | --- | --- |
...
5.
In the absolute temperature scale, the zero of the scale  corresponds to the temperature
where every substance in nature has the least possible molecular activity. The Kelvin
| absolute temperature scale ( | T | ) has the same unit size as the Celsius scale ( | T | c | ), but |
| --- | --- | --- | --- | --- | --- |
...
6.
| The coefficient of linear expansion ( | α | l | ) and volume expansion ( | α | v | ) are defined by the |
| --- | --- | --- | --- | --- | --- | --- |
...
8.
The latent heat of fusion (*L*f) is the heat per unit mass required to change a substance
from solid into liquid at the same temperature and pressure. The latent heat of
vaporisation (*L*v) is the heat per unit mass required to change a substance from liquid
...
| --- | --- | --- |
| cross section | A | with its ends maintained at temperatures | T | C | and | T | D | , the rate of flow of |
...
*Q = – k T* *– T*
*t*
| Where | T | 1 | is the temperature of the surrounding medium and | T | 2 | is the temperature of |
| --- | --- | --- | --- | --- | --- | --- |
...
**POINTS TO PONDER**
1.
| The relation connecting Kelvin temperature ( | T | ) and the Celsius temperature | t | c |
| --- | --- | --- | --- | --- |
...
**10.2**
Two absolute scales *A* and *B* have triple points of water defined to be 200 A and    350
B. What is the relation between *T*A and *T*B ?

**10.3**
The electrical resistance in ohms of a certain thermometer varies with temperature
...
(c)
| The absolute temperature (Kelvin scale) | T | is related to the temperature | t | c | on |
| --- | --- | --- | --- | --- | --- |
...
**10.5**
Two ideal gas thermometers *A* and *B* use oxygen and hydrogen respectively.  The
...
**10.10**
A brass rod of length 50 cm and diameter 3.0 mm is joined to a steel rod of the same
...
**10.11**
| The coefficient of volume expansion of glycerine is 49 | × | 10 | –5 | K | –1 | .  What is the fractional |
| --- | --- | --- | --- | --- | --- | --- |
...
**10.13**
| A copper block of mass 2.5 kg is heated in a furnace to a temperature of 500 | ° | C and |
| --- | --- | --- |
...
**10.17**
A ‘thermacole’ icebox is a cheap and an efficient method for storing small quantities
...
| conductivity of thermacole is 0.01 J s | –1 | m | –1 | K | –1 | . [Heat of fusion of water = 335 | × | 10 | 3 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
