...
**Fig. 11.1**
*(a) Systems A and B (two gases) separated*
...
volume of the gases be (*P**A*, V*A*) and (*P**B*, *V**B*)
...
found that any possible pair of values (*P**A*, *V**A*) will
be in equilibrium with any possible pair of values
(*P**B*, *V**B*).  Next, suppose that the adiabatic wall is
...
(*P**B* ′, *V**B* ′) and (*P**A* ′, *V**A* ′) such that the new states
...
with *C*, *T**A* = *T**C*  and *T**B* = *T**C*.  This implies that
*T**A* = *T**B* i.e. the systems *A* and *B* are also in
thermal equilibrium.
...
**Fig. 11.2**
*(a) Systems A and B are separated by an*
...
(*P*1, *V*1) to (*P*2, *V*2), we can first change the
volume of the gas from *V*1 to *V*2, keeping its
pressure constant i.e. we can first go the state
(*P*1, *V*2) and then change the pressure of the
gas from *P*1 to *P*2, keeping volume constant, to
take the gas to (*P*2, *V*2).  Alternatively, we can
...
dimensions, the average energy is 3 *k**B**T*.
For a mole of a solid, the total energy is

*U*  = 3 *k**B**T*  × *N**A*  = 3 *RT* (∵*k**B**T*  × *N**A* =*R*)
...
**Fig. 11.5**
*Variation of specific heat capacity of*
...
is 4186 J kg–1 K–1 i.e. 4.186 J g–1 K–1. The so
...
(Fig.11.7).  To take a gas from the state (*P*, *T* ) to
...
temperature *T* ) from its initial state (*P*1, *V*1) to
the final state (*P*2, *V*2).  At any intermediate stage
...
for *V*2 > *V*1,  *W* > 0; and for *V*2 < *V*1, *W* < 0.  That
...
its state adiabatically from (*P*1, *V*1) to (*P*2, *V*2) :
...
state (*P*1, *V*1, *T*1) to the state (*P*2, *V*2, *T*2).
...
From Eq. (11.14), the constant is *P*1*V*1
γ  or *P*2*V*2
γ
...
*T*2 < *T*1.  On the other hand, if work is done on
...
reservoirs at temperatures *T*1 and *T*2? It turns
...
*T*1 and a cold reservoir at temperature *T*2.  What
...
*T*1 absorbing heat *Q*1 from the hot reservoir, and
another isothermal process at temperature *T*2
releasing heat *Q*2 to the cold reservoir. To
complete a cycle, we need to take the system
from temperature *T*1 to *T*2 and then back from
temperature *T*2 to *T*1.  Which processes should
...
temperature range *T*2 to *T*1 to ensure that at each
...
temperature change in the system from *T*1 to *T*2
and *T*2 to *T*1 in this engine.
...
taking its  state from (*P*1, *V*1, *T*1)  to
(*P*2,*V*2, *T*1).

The heat absorbed by the gas (*Q*1) from the
reservoir at temperature *T*1 is given by
Eq. (11.12). This is also the work done (*W*1 → 2)
by the gas on the environment.

*W*1 → 2  =  *Q*1 = µ *R* *T*1  ln
...
from (*P*2, *V*2, *T*1) to (*P*3, *V*3, *T*2)
...
gas from (*P*3, *V*3, *T*2) to (*P*4, *V*4, *T*2).

Heat released (*Q*2) by the gas to the reservoir
at temperature *T*2 is given by Eq. (11.12).  This
is also the work done (*W*3 → 4) on the gas by the
environment.
...
gas from (*P*4, *V*4, *T*2) to (*P*1,*V*1, *T*1).
...
be reversed. This will amount to taking heat *Q*2
from the cold reservoir at *T*2, doing work *W* on
the system, and transferring heat *Q*1 to the hot
...
(a) working between two given temperatures *T*1
and *T*2 of the hot and cold reservoirs respectively,
...
Let *I* absorb heat *Q*1 from the source, deliver
work *W*′ and release the heat *Q*1- *W*′  to the sink.
We arrange so that *R* returns the same heat *Q*1
to the source, taking heat *Q*2 from the sink and
requiring work *W*= *Q*1 – *Q*2 to be done on it.
Now suppose ηR < ηI i.e. if *R* were to act
...
Thermodynamics.  Hence the assertion ηI > ηR
...
of the system.  Here *Q*1 and *Q*2 are respectively,
...
than that of *I* i.e. *W* < *W* ′ for a given *Q*1. With *R*
acting like a refrigerator, this would mean
*Q*2 =  *Q*1 – *W* >  *Q*1 – *W*′. Thus, on the  whole,
the coupled *I*-*R* system extracts heat
(*Q*1 – *W)* – (*Q*1 – *W*′) = (*W*′ – *W* ) from the cold
...
8.
| In an isothermal expansion of an ideal gas from volume | V | 1 | to | V | 2 | at temperature | T | the |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Work done by an ideal gas in an adiabatic change of state from ( | P | 1 | , | V | 1 | , | T | 1 | ) to ( | P | 2 | , | V | 2 | , | T | 2 | ) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| 12. | Carnot engine is a reversible engine operating between two temperatures | T | 1 | (source) and |
| --- | --- | --- | --- | --- |

*T*2 (sink). The Carnot cycle consists of two isothermal processes connected by two
...
**11.3**
Explain why
(a) Two bodies at different temperatures *T*1 and *T*2 if brought in thermal contact do
| not necessarily settle to the mean temperature ( | T | 1 | + | T | 2 | )/2. |
| --- | --- | --- | --- | --- | --- | --- |
