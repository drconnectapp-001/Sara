...
body constitutes mostly of water. All the  processes occurring
...
piston of area *A*then the **average pressure** *P**av*
...
* *STP means standard temperature (0**0**C) and 1 atm pressure.*
...
Thus, the fluid exerts pressures *P*a, *P*b and *P*c on

this element of area corresponding to the normal
forces *F*a, *F*b and *F*c as shown in Fig. 9.2 on the
faces BEFC, ADFC and ADEB denoted by *A*a, *A*b
and *A*c respectively. Then
*F*b sinθ = *F*c,
*F*b cosθ = *F*a (by equilibrium)
*A*b sinθ = *A*c,
*A*b cosθ = *A*a (by geometry)
Thus,
...
The pressures at points 1 and 2 are *P*1 and *P*2
...
the fluid pressure at the top (*P*1*A*) acting
downward, at the bottom (*P*2*A*) acting upward.
If *mg* is weight of the fluid in the cylinder we
have
(*P*2 − *P*1) *A* = *mg*
(9.5)
Now, if ρ is the mass density of the fluid, we
have the mass of fluid to be *m* = ρ*V*= ρh*A* so
that
*P*2 − *P*1=  ρ*gh*
(9.6)
...
**Fig.9.3**
*Fluid under gravity. The effect of gravity is*
...
amount ρ*gh*. The excess of pressure, *P* − *P*a, at
...
is *P* − *P*a, given by Eq. (9.8) and is proportional to
manometer height *h*.
...
ρ*gh*  =  1.29 kg m–3 × 9.8 m s2 × *h*  m = 1.01 × 105 Pa
...
the interior of which is maintained at sealevel atmospheric pressure. (The density of
...
≈ 104 atm
(b)
Gauge pressure is *P* − *P*a = ρ*gh* = *P*g
*P*g = 1.03 × 103 kg m–3 × 10 ms2 × 1000 m
= 103 × 105 Pa
≈ 103 atm
(c)
The pressure outside the submarine is
*P* = *P*a + ρ*gh* and the pressure inside it is *P*a.
Hence, the net pressure acting on the
window is gauge pressure, *P*g = ρ*gh*. Since
...
cross-section*A*1 is used to exert a force *F*1 directly
...
cylinder attached with a larger piston of area *A*2,
which results in an upward force of *P**×**A*2.
Therefore, the piston is capable of supporting a
large force (large weight of, say a car, or a truck,

placed on the platform) *F*2 = *PA*2 =
...
changing the force at *A*1, the platform can be
...
lifted is 1350 kg, calculate *F*1. What is the
...
**Fig. 9.7**
*The meaning of streamlines. (a) A typical*
...
at three points P, R and Q in Fig.9.7 (b). The plane
...
are *A*P,*A*R and *A*Q and speeds of fluid particles
are *v*P, *v*R and *v*Q, then mass of fluid ∆*m*P crossing
at *A*P in a small interval of time ∆*t* is ρP*A*P*v*P ∆*t*.
Similarly mass of fluid ∆*m*R flowing or crossing
at *A*R in a small interval of time ∆*t* is  ρR*A*R*v*R ∆*t*
and mass of fluid  ∆*m*Q is ρQ*A*Q*v*Q ∆*t* crossing at
*A*Q. The mass of liquid flowing out equals the
mass flowing in, holds in all cases. Therefore,
ρP*A*P*v*P∆*t* = ρR*A*R*v*R∆*t* = ρQ*A*Q*v*Q∆*t*
(9.9)
For flow of incompressible fluids
ρP = ρR = ρQ
Equation (9.9) reduces to
*A*P*v*P = *A*R*v*R = *A*Q*v*Q
(9.10)
...
is clear that *A*R  > *A*Q or   *v*R <  *v*Q, the fluid is
...
*v*1 is the speed at B and *v*2 at D, then fluid initially
at B has moved a distance *v*1∆*t* to C (*v*1∆*t* is small
enough to assume constant cross-section along
BC). In the same interval ∆*t* the fluid initially at
D moves to E, a distance equal to *v*2∆*t*. Pressures
*P*1 and *P*2 act as shown on the plane faces of
areas *A*1 and *A*2 binding the two regions. The
work done on the fluid at left end (BC) is *W*1 =
*P*1*A*1(*v*1∆*t*) = *P*1∆*V*. Since the same volume ∆*V*
passes through both the regions (from the
equation of continuity) the work done by the fluid
at the other end (DE) is *W*2 = *P*2*A*2(*v*2∆*t*) = *P*2∆*V* or,

the work done on the fluid is  –*P*2∆*V*. So the total
...
of the fluid is ρ and ∆*m* = ρ*A*1*v*1∆*t* = ρ∆*V* is the
...
applies to fluids with zero viscosity or nonviscous fluids. Another restriction on application
...
Bernoulli’s equation also does not hold for nonsteady or turbulent flows, because in that
...
at a height *y**1* from the bottom (see Fig. 9.10).
The air above the liquid, whose surface is at
height *y**2*, is at pressure *P*. From the equation of
...
*v**1*∆*t moves to the section of length v**2*∆*t in*
*time*∆*t.*

MECHANICAL PROPERTIES OF FLUIDS

If the cross-sectional area of the tank *A**2* is
much larger than that of the hole (*A**2* >>*A**1*), then
we may take the fluid to be approximately at rest
at the top, i.e., *v**2* = 0. Now, applying the Bernoulli
equation at points 1 and 2 and noting that at
the hole *P**1* = *P**a*, the atmospheric pressure, we
have from Eq. (9.12)
...
When *P* >>*P**a*and *2 g h*may be ignored, the
...
open to the atmosphere, then *P*  = *P**a*and
...
(i)
**Ball moving without spin**: Fig. 9.11(a)
...
**Fig. 9.10**
*Torricelli’s law. The speed of efflux, v**1**,*
...
where *v*2 is the speed of air over the upper
surface and *v*1 is the speed under the bottom
surface.
...
*v*av = (*v*2 + *v*1)/2 = 960 km/h = 267 m s-1,
...
change of strain’ or ‘strain rate’ i.e. ∆*x*/(*l* ∆*t*) or
...
**Fig. 9.13**
*Measurement of the coefficient of viscosity*
*of a liquid.*
...
equilibrium, this terminal velocity *v*t is given by
...
So the terminal velocity *v*t depends on the
...
**Answer** We have *v*t = 6.5 × 10-2 ms-1, *a* = 2 × 10-3 m,
...
**Fig. 9.14**
*Schematic picture of molecules in a liquid, at the surface and balance of forces. (a) Molecule inside*
...
experimentally as schematically shown in Fig.
...
by q. It is different at interfaces of different pairs
of liquids and solids. The value of q determines
...
solid-liquid denoted by *S*la, *S*sa and *S*sl , respectively
...
*S*la cos q  +  *S*sl =  *S*sa
(9.22)

The angle of contact is an obtuse angle if
*S*sl  > *S*la as in the case of water-leaf interface
while it is an acute angle if *S*sl  < *S*la as in the
case of water-plastic interface. When q is an
...
cos q may increase or q may decrease. In this
case q is an acute angle. This is what happens
for water on glass or on plastic and for kerosene
oil on virtually anything (it just spreads). Soaps,
detergents and dyeing substances are wetting
...
bubbles stable?
As we have been saying repeatedly, a liquidair interface has energy, so for a given volume
...
in equilibrium. If its radius increase by D*r*. The
extra surface energy is

[4p(*r* + D*r*) 2- 4p*r*2] *S*la = 8p*r* D*r S*la
(9.23)

If the drop is in equilibrium this energy cost is
balanced by the energy gain due to
expansion under the pressure difference (*P*i – *P*o)
...
concave side (inside) has a higher pressure than
the convex side (outside). For example, an air
bubble in a liquid, would have higher pressure
inside it. See Fig 9.18 (b).
...
across a curved liquid-air interface is the wellknown effect that water rises up in a narrow
...
**Fig. 9.19**
*Capillary rise, (a) Schematic picture of a*
...
in a liquid is given by 2*S/r*, where *S* is the
...
excess pressure in that case is 4*S/r.*) The
radius of the bubble is r. Now the pressure
outside the bubble *P*o equals atmospheric
pressure plus the pressure due to 8.00 cm of
water column. That is
*P*o = (1.01 × 105 Pa + 0.08 m × 1000 kg m–3
...
3.
| If | F | is the normal force exerted by a fluid on an area | A | then the average pressure | P | av |
| --- | --- | --- | --- | --- | --- | --- |
...
5.
*Pascal’s law* states that: Pressure in a fluid at rest is same at all points which are
...
*P* = *P*a + r*gh*
where  r is the density of the fluid, assumed uniform.
...
pressure (*P*), the kinetic energy per unit volume (r*v*2/2) and the potential energy per
unit volume (r*gy*) remains a constant.
*P* + r*v*2/2 + r*gy* = constant

The equation is basically the conservation of energy applied to non viscous fluid
motion in steady state. There is no fluid which has zero viscosity, so the above
...
velocity **v** through a fluid of viscosity is, **F** = 6ph*a****v***.
...
(b)
Viscosity of gases ... with temperature, whereas viscosity of   liquids  ...  with
...
(e)
For the model of  a plane in a wind tunnel, turbulence occurs at a ... speed for
...
**9.7**
| A vertical off-shore structure is built to withstand a maximum stress of 10 | 9 | Pa. Is |
| --- | --- | --- |
...
| kg. The area of cross-section of the piston carrying the load is 425 cm | 2 | . What |
| --- | --- | --- |
...
| upper and lower surfaces of the wing are 70 m s | –1 | and 63 m s | -1 | respectively. What is |
| --- | --- | --- | --- | --- |
| the lift on the wing if its area is 2.5 m | 2 | ? Take the density of air to be 1.3 kg m | –3 | . |
...
**9.16**
| The cylindrical tube of a spray pump has a cross-section of 8.0 cm | 2 | one end of |
| --- | --- | --- |
...
**9.18**
| Figure 9.21 (a) shows a thin liquid film supporting a small weight = 4.5 | × | 10 | –2 | N. |
| --- | --- | --- | --- | --- |
