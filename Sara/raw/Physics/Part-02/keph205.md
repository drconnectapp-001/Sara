...
and is denoted by *N*A. The mass of 22.4 litres of
...
where  µ   is the number of moles and *R*  = *N*A
*k*B is a universal constant. The temperature *T* is
...
molecules, *M*0 is the molar mass and *N*A the
...
molecules per unit volume. *k*B is  the Boltzmann
...
**Fig.12.2**
*Experimental P-V curves (solid lines) for*
...
Clearly *P*1 =    µ1 *R T/V*   is the pressure that
...
**Fig. 12.3** *Experimental T-V curves (solid lines) for CO**2*
...
*V*1/3 or 10 times, i.e., 10 × 2 Å  = 20 Å. So the
average distance is 2 × 20 = 40  Å.
⊳

**Example 12.4** A vessel contains two nonreactive gases : neon (monatomic) and
...
the two gases,  we  have  *P*1*V* = µ 1 *RT* and *P*2*V* =
µ2 *RT*, i.e. (*P*1/*P*2) = (µ1 / µ2). Here 1 and 2 refer
to neon and oxygen respectively. Since (*P*1/*P*2) =
(3/2) (given), (µ1/ µ2) = 3/2.
(i)
By definition µ1 = (*N*1/*N*A ) and µ2 = (*N*2/*N*A)
where *N*1 and *N*2 are the number of molecules
of 1 and 2, and *N*A is the Avogadro’s number.
Therefore, (*N*1/*N*2) = (µ1 / µ2)  = 3/2.
(ii) We can also write µ1 = (*m*1/*M*1) and µ2 =
(*m*2/*M*2) where *m*1 and *m*2 are the masses of
1 and 2; and *M*1 and *M*2 are their molecular
masses. (Both *m*1 and *M*1; as well as *m*2 and
*M*2 should be expressed in the same units).
...
(*v**x**, v**y**, v**z* ) hits the planar wall parallel to *yz*plane of area *A* (= *l*2). Since the collision is elastic,
...
molecule is:  –*mv**x* – (*mv**x*) = – 2*mv**x*. By the
...
velocity (*v**x**, v**y**, v**z* )  hitting the wall in time ∆*t* is
½*A v**x*  ∆*t n,* where *n* is the number of molecules
...
speed *v**x*  in  the *x*-direction and n stands for the
...
∆*t*, a molecule with *x*-component of velocity *v**x*
will hit the wall if it is within the distance *v**x* ∆*t*
from the wall. That is, all molecules within the
volume *Av**x*∆*t* only can hit the wall in time ∆*t*.
...
after a collision acquires the velocity  (*v**x**, v**y**, v**z* ).
...
*v*
=  3 *k**B**T* / *m*    =    (516)2 m2s-2

The square root of
*v*
is known as root mean
square (rms) speed and is denoted by *v*rms,
( We can also write
*v*
as   < *v*2 >.)
*v*rms   =    516 m s-1
...
*v*rms of the molecules of the two gases.
...
(3/2) *k**B**T*. It depends only on temperature, and
...
molecule =  (3/2) ) *k*B*T* where *m* is the mass
...
energy  = ½ *m* <*v*2 > is constant. So  smaller the
...
ball is *V* + (*V* + *u*) = 2*V* + *u*, moving away from the
...
*v**y* and *v**z*. In, Eq. (12.24) we see that in thermal
...
**Fig. 12.6**
*The two independent axes of rotation of*
*a diatomic molecule*

where ω1 and ω2  are the angular speeds about
the axes 1 and 2 and *I*1, *I*2 are the corresponding
...
variables of motion *y* and d*y/*d*t* .
...
average energy is ½ *k**B**T*. The most elegant
...
energy equal to  ½ *k**B**T*. This is known as the **law**
**of equipartition of energy**. Accordingly, each
translational and rotational degree of freedom
of a molecule contributes ½ *k**B**T*  to the energy,
while each vibrational frequency contributes
2 × ½ *k**B**T*  = *k**B**T* ,  since a vibrational mode has
...
*T* is (3/2)*k*B*T* .  The total internal energy of a mole
of such a gas is
...
Note that *C**p**– C**v**= R* is true for any ideal
...
**Table 12.1**
**Predicted values of specific heat**
...
**Answer** Using the gas law *PV* = µ*RT*, you can
...
specific heat at constant volume, *C**v* = (3/2) *R*,
and molar specific heat at constant pressure,
*C**p* = (3/2) *R + R* = (5/2) *R*.  Since the volume of
the cylinder is fixed, the heat required is
determined by *C**v*. Therefore,
...
average energy of 2 × ½ *k**B**T* = *k**B**T* . In three
dimensions, the average energy is 3 *k**B**T*. For a
...
volume π*d*2 <*v*> ∆*t* wherein any other molecule
will collide with it (see Fig. 12.7). If *n* is the
number of molecules per unit volume, the
molecule suffers *n*π*d*2 <*v*> ∆*t* collisions in time
∆*t*. Thus the rate of collisions is  *n*π*d*2 <*v*> or the
...
(*T*) is
*PV* = µ *RT*     = *k**B**NT*
| where | µ | is the number of moles and | N | is the number of molecules. | R | and | k | B | are universal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

constants.

*R* = 8.314 J mol–1 K–1,     *k**B*  =
...
| absorption, the energy in each mode being equal to ½ | k | B | T | . Each translational and |
| --- | --- | --- | --- | --- |

rotational degree of freedom corresponds to one energy mode of absorption and has
energy ½ *k**B**T*. Each vibrational frequency has two modes of energy (kinetic and potential)
...
6.
The mean free path *l*is the average distance covered by a molecule between two successive
collisions :
...
kinetic energy ½ *mv*2 of the molecules.
5.
< *v*2 >  is not always equal to ( < *v* >)2. The average of a squared quantity is not necessarily
...
12.3
12.3
| Figure 12.8 shows plot of | PV/T | versus | P | for 1.00 | × | 10 | –3 | kg of oxygen gas at two |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
12.4
12.4
An oxygen cylinder of volume 30 litre has an initial gauge pressure of 15 atm and a
...
| --- | --- | --- |
| oxygen taken out of the cylinder ( | R | = 8.31 J mol | –1 | K | –1 | , molecular mass of O | 2 | = 32 u). |
...
| vapour and other constituents) in a room of capacity 25.0 m | 3 | at a temperature of |
| --- | --- | --- |
...
12.8
12.8
Three vessels of equal capacity have gases at the same temperature and pressure. The
...
| the same in the three cases? If not, in which case is | v | rms | the largest ? |
| --- | --- | --- | --- |
...
| cylinder containing nitrogen at 2.0 atm and temperature 17 | 0 | C. Take the radius of a |
| --- | --- | --- |
