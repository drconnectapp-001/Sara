...
| M | ECHANICAL | P | ROPERTIES | OF | S | OLIDS |
| --- | --- | --- | --- | --- | --- | --- |
...
**ultimate tensile strength** (σ*u*) of the material.
...
**Answer**
The copper and steel wires are under
...
*W/A = Y**c* × (∆*L**c*/*L**c*) = *Y**s* × (∆*L**s*/*L**s*)
where the subscripts *c* and *s*refer to copper
and stainless steel respectively. Or,
∆*L**c*/∆*L**s* = (*Y**s**/Y**c*) × (*L**c**/L**s*)
Given *L**c* = 2.2 m, *L**s* = 1.6 m,
From Table 9.1 *Y**c* = 1.1 × 1011 N.m–2, and
*Y**s* = 2.0 × 1011 N.m–2.
∆*L**c*/∆*L**s* = (2.0 × 1011/1.1 × 1011) × (2.2/1.6) = 2.5.
The total elongation is given to be
∆*L**c* + ∆*L**s* =  7.0  × 10-4 m
Solving the above equations,
∆*L**c* = 5.0  × 10-4 m,   and   ∆*L**s* = 2.0  × 10-4 m.
Therefore
*W*   = (*A*× *Y**c* × ∆*L**c*)/*L**c*
...
u**Example 8.3** In a human pyramid in a
...
**Answer**
Total mass of all the performers, tables,
plaques etc.
= 280 kg
...
small length d*l*, work done d*W* is *F* *×* d*l* or *YAl*d*l/*
...
2 ×  Young’s modulus × strain2 ×

volume of the wire

= 1

2 ×  stress × strain × volume of the
...
yield strength (σ*y*) of about 300 × 106 N m–2. Thus,
...
mountain is *h*ρ*g* where ρ is the density of the
...
There is a shear component, approximately *h*ρ*g*
itself. Now the elastic limit for a typical rock is
30 × 107 N m-2. Equating this to *h*ρ*g*, with
...
| the weight. However, the tension at any cross-section | A | of the wire is just | F | and not 2 | F | . |
| --- | --- | --- | --- | --- | --- | --- |
...
**8.1**
| A steel wire of length 4.7 m and cross-sectional area 3.0 | × | 10 | -5 | m | 2 | stretches by the same |
| --- | --- | --- | --- | --- | --- | --- |
| amount as a copper wire of length 3.5 m and cross-sectional area of 4.0 | × | 10 | –5 | m | 2 | under |
...
| litre, Pressure increase = 100.0 atm (1 atm = 1.013 | × | 10 | 5 | Pa), Final volume = 100.5 litre. |
| --- | --- | --- | --- | --- |
